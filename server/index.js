...
const stripe=new Stripe('sk_test_51QMCy8Fd6w6hK8ym9uHv4YI0t5VxeCvzwlZgtYu6J1P306Jf7UI1aCwGXKjt3HHdZi8AvRqzAuKOVISW0PcXGZjM00ZNt4DEus');
...
mongoose.connect('mongodb+srv://kumarnithish357:S9MHcAxELnW8fSnM@cluster0.9ohkx.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0', { 
    ...
    app.post('/book-ticket', async (req, res)=>{
        const {user, flight, flightName, flightId,  departure, destination, 
                    email, mobile, passengers, totalPrice, journeyDate, journeyTime, seatClass,token} = req.body;
        ...
        try{
            ...
            const booking = new Booking({user, flight, flightName, flightId, departure, destination, 
                                            email, mobile, passengers, totalPrice, journeyDate, journeyTime, seatClass, seats,token});
            await booking.save();

            res.json({message: 'Booking successful!!'});
            res.send('Payment Successfull , booked');
        }catch(err){
            console.log(err);
        }
